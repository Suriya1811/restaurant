        ...
        <div className="flex-1 flex flex-col min-h-0 bg-white">
            ...
            <div className="bg-white px-4 py-3 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-sm z-10">
                <div className="flex items-center gap-2">
                    <span className="text-sm font-bold text-slate-800 uppercase tracking-widest hidden sm:block">Customer Outstanding</span>
                </div>
            ...
            <div className="px-4 py-3 border-b border-slate-100 bg-slate-50/50">
                <div className="flex gap-4 overflow-x-auto custom-scrollbar">
                    <div className="flex-1 min-w-[200px]">
                        ...
                        <div className="text-xl font-bold text-slate-800">{summary.customerCount}</div>
                    </div>
                    <div className="flex-1 min-w-[200px]">
                        <div className="text-xs text-slate-500 font-semibold mb-1">Aggregate Outstanding</div>
                        <div className="text-xl font-bold text-amber-600">₹{summary.totalOutstanding.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</div>
                    </div>
                </div>
            </div>
                            ...
                            <table className="w-full text-left border-collapse whitespace-nowrap min-w-[600px]">
                                <thead className="sticky top-0 bg-[#F8FAFC] z-10 border-b border-slate-200 shadow-sm text-[10px] font-black text-slate-500 uppercase tracking-widest">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3">Engagement Detail</th>
                                        <th className="px-6 py-3 text-right">Outstanding Aggregate</th>
                                    </tr>
                                </thead>
                                        ...
                                        data.map((item, ix) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-3">
                                                    {item.phone || <span className="text-slate-400 italic text-xs">No Contact Provided</span>}
                                                </td>
    ...
    return (
        <div className="dashboard-layout bg-white">
            ...
            <main className="dashboard-main flex-1 overflow-hidden font-sans flex flex-col bg-slate-50">
                <Header toggleSidebar={toggleSidebar} title="Customer Outstanding Summary" />
