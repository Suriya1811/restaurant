import{E as l,a as b}from"./jspdf.plugin.autotable-CYAym7eK.js";const h=(a,r,d,i)=>{const e=r.map(n=>`"${n}"`).join(","),t=d.map(n=>n.map(p=>`"${String(p!=null?p:"-").replace(/"/g,'""')}"`).join(",")),s="data:text/csv;charset=utf-8,"+encodeURIComponent(`${a}
